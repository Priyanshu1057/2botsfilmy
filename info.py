...
auth_channels     = environ.get("AUTH_CHANNELS", "-1001647411072 -1001666034664")# Channels for force sub (make sure bot is admin)
...
THREE_VERIFY_GAP = int(environ.get('THREE_VERIFY_GAP', "57600"))    
